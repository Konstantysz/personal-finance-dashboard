...
| `/validate` | `personal-finance-dashboard validate` | works |
| `/analysis` | `personal-finance-dashboard analyze` | works |
| `/monthly` | `personal-finance-dashboard monthly` | spec, CLI is a stub |
| `/category <nazwa>` | `personal-finance-dashboard category` | spec, CLI is a stub |
| `/investments` | `personal-finance-dashboard invest` | spec, CLI is a stub |
| `/taxes` | - | spec, no decision yet on CLI placement |
| `/goal <nazwa>` | `personal-finance-dashboard goal` | spec, CLI is a stub |
